                        ...
                        <div class="card-body">
                            <form action="/razorpay" method="POST">
                                ...
                                {{-- <div class="form-group">
                                    ...
                                    <p><input type="radio" value="online" name="payment">
                                        <spam>Online Payment</spam>
                                    </p>
                                    <p><input type="radio" value="cash" name="payment">
                                        <spam>Cash On Delivery</spam>
                                    </p>
                                    <p><input type="radio" value="EMI" name="payment">
                                        <spam>Emi System</spam>
                                    </p>
                                </div> --}}
